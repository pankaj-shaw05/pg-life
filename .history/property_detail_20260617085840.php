            ...
            foreach($amenity_types as $type) {
                ...
                if($result && mysqli_num_rows($result)>0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<img src="img/amenities/'.$row["icon"].'.svg">';
    ...
    <div class="page-container">
        ...
        <div class="testimonial-card">
            <div class="text-center">
                <img src="img/images/user.png" alt="User" class="rounded-circle testimonial-img">
            </div>
            <div class="testimonial-content">
                <p>"<?php echo $testimonial["content"]; ?>"</p>
                <p class="testimonial-author">- <?php echo $testimonial["user_name"]; ?></p>
            </div>
        </div>
        <?php } ?>
    </div>
