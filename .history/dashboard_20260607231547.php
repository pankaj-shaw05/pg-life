    ...
    <nav class="navbar navbar-expand-md navbar-light">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="my-navbar">
            <ul class="navbar-nav align-items-center">
                <li class="nav-item">
                    <span class="nav-link nav-name">Hi, Aditya Sood</span>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-9">
            <div class="row no-gutters justify-content-between align-items-end">
                <div class="profile">
                    ...
                    <div class="college">ABC College</div>
                </div>
                <div class="edit">
...
<div class="footer">
    <div class="page-container footer-container">
        <div class="footer-cities">
            <div class="footer-city"><a href="#">PG in Delhi</a></div>
            <div class="footer-city"><a href="#">PG in Mumbai</a></div>
            <div class="footer-city"><a href="#">PG in Bangalore</a></div>
            <div class="footer-city"><a href="#">PG in Hyderabad</a></div>
        </div>
