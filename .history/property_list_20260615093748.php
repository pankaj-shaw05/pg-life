...
<div class="modal fade" id="filter-modal" tabindex="-1" role="dialog">
    ...
    <hr />
    <div>
        <a href="property_list.php?city=<?php echo $city; ?>">
            <button class="btn btn-outline-dark">No Filter</button>
        </a>
        <a href="property_list.php?city=<?php echo $city; ?>&gender=male">
            <button class="btn btn-outline-dark">
                <i class="fas fa-mars"></i> Male
            </button>
        </a>
        <a href="property_list.php?city=<?php echo $city; ?>&gender=female">
            <button class="btn btn-outline-dark">
    ...
    <hr />
    <div>
        <a href="property_list.php?city=<?php echo $city; ?>&filter=rent_desc">
            <button class="btn btn-outline-dark">Highest rent first</button>
        </a>
        <a href="property_list.php?city=<?php echo $city; ?>&filter=rent_asc">
            <button class="btn btn-outline-dark">Lowest rent first</button>
        </a>
    </div>
</div>
                    ...
                    <div class="interested-container">
                        <?php if(isset($_SESSION["user_id"])) {
                            ...
                            if(mysqli_num_rows($liked_result) == 1) {
                                echo '<i class="fas fa-heart" style="color:#EA322E;"></i>';
                            } else {
